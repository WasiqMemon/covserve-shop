...
namespace Project_retail.NorthwindDataSet2TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ([Pro" +
                "ductName] = @Original_ProductName) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] I" +
                "S NULL) OR ([UnitPrice] = @Original_UnitPrice)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [UnitPrice]) VALUES (@ProductName, @" +
                "UnitPrice);\r\nSELECT ProductID, ProductName, UnitPrice FROM Products WHERE (Produ" +
                "ctID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [UnitPrice] = @UnitPrice WHERE (([ProductID] = @Original_ProductID) AND ([ProductName] = @Original_ProductName) AND ((@IsNull_UnitPrice = 1 AND [UnitPrice] IS NULL) OR ([UnitPrice] = @Original_UnitPrice)));
SELECT ProductID, ProductName, UnitPrice FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, UnitPrice FROM dbo.Products";
        ...
        public virtual int Fill(NorthwindDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual NorthwindDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NorthwindDataSet2.ProductsDataTable dataTable = new NorthwindDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NorthwindDataSet2.ProductsDataTable dataTable) {
